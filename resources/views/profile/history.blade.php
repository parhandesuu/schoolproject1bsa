...
<div class="bg-gradient-to-r from-blue-800 to-blue-900 py-16">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <nav class="text-white/60 text-sm"><a href="{{ route('home') }}" class="hover:text-white">Beranda</a> / <a href="{{ route('profile.index') }}" class="hover:text-white">Profil</a> / Sejarah</nav>
    </div>
</div>
